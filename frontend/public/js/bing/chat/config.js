...
_w['_sydConvConfig'] = {
  ...
  enableTigerEnhancedPrompt: true,
  ...
  sydBaseUrl: 'https://bing.workers.xr21.me',
  compSydBaseUrl: '',
  ...
  enableSydShare: true,
  enableTigerCachedAttr: true,
  enableSydCarouselHistory: true,
  enableSydCookLoc: true,
  enableSQMsg: true,
  enable161Feats: true,
  addDv3Opt: true,
  addGenContentv3Opt: true,
  hideSydReconnect: true,
  enableErrorTelemetry: true,
  enableSemSerpNoCache: false,
  checkCreatorAnsFor1T: true,
  enableSydStrictRedirect: true,
